    ...
    return (
      ...
      {showQRModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className={`p-6 rounded-lg w-96 ${darkMode ? "bg-gray-800 text-white" : "bg-white"}`}>
            ...
            <div className="flex justify-center mb-4">
              ...
              <svg 
                viewBox="0 0 200 200" 
                className={`w-48 h-48 ${darkMode ? "text-white" : "text-black"}`}
              >
                <rect x="20" y="20" width="160" height="160" fill="none" stroke="currentColor" strokeWidth="2"/>
                <path d="M40 40h40v40h-40z M120 40h40v40h-40z M40 120h40v40h-40z" fill="currentColor"/>
                <path d="M90 90h20v20h-20z M120 120h20v20h-20z" fill="currentColor"/>
              </svg>
            </div>
